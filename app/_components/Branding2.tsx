  ...
  return (
    ...
    >
      ...
      <motion.h1
        ...
        className={`font-streach absolute ml-10 mb-10 z-[-1] uppercase text-white text-4xl ${roxter.className}`}
      >
        {SITE_NAME}
      </motion.h1>
      <motion.h1
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 1, delay: 2 }}
        className={`font-streach absolute ml-10 mb-10 z-[-1] uppercase [-webkit-text-stroke:1px_#ffffff] text-transparent text-4xl z-50 text-center ${roxter.className}`}
      >
        {SITE_NAME}
      </motion.h1>
      <div className="absolute z-10 -top-140">
        <motion.img
          initial={{ y: 500 }}
          ...
          src={airoplane.src}
          alt={"Plane"}
          className="rotate-180 h-360 object-cover rotate-y-180!"
        />
      </div>
